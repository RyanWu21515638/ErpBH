productModule.service('flowService', function ($resource, $http, $rootScope) {
    ...
    this.getNoMaterial = function (x) {
        return $http.get($rootScope.ip + '/rlerp/home/Project/get_Material?prj_id=' + x);
    }
    ...
    this.getProjectNew = function () {
        return $http.get($rootScope.ip + '/rlerp/Home/project/projectNew?company_id=1');
    }
