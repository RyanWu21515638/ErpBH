...
formApp
    .controller('formController', function ($scope, $http, $state, $window, $cookies, $rootScope, $timeout, flowService) {
        ...
        $scope.logout = function () {
            ...
            $http.post($rootScope.ip + "/rlerp/index.php/home/user/exit_login", $scope.formData, $scope.postCfg).success(
                function (res) {
                    $state.go("index");
                }).error(function (e) {
                    alert(e.toString());
        ...
        $scope.login = function () {
            $http.post($rootScope.ip + "/rlerp/index.php/home/user/loginPOST", $scope.formData, $scope.postCfg).success(
                function (user) {
                    if (user.success) {
